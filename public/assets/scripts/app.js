...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();\n\nvar _dispatcher5 = __webpack_require__(/*! @core/dispatcher */ \"./core/dispatcher.js\");\n\nvar _dispatcher6 = _interopRequireDefault(_dispatcher5);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nvar _class = function () {\n  function _class() {\n    _classCallCheck(this, _class);\n\n    this._dispatcher = new _dispatcher6.default();\n\n    this.init && this.init.apply(this, arguments);\n  }\n\n  _createClass(_class, [{\n    key: 'on',\n    value: function on() {\n      var _dispatcher;\n\n      (_dispatcher = this._dispatcher).on.apply(_dispatcher, arguments);\n      return this;\n    }\n  }, {\n    key: 'once',\n    value: function once() {\n      var _dispatcher2;\n\n      (_dispatcher2 = this._dispatcher).once.apply(_dispatcher2, arguments);\n      return this;\n    }\n  }, {\n    key: 'off',\n    value: function off() {\n      var _dispatcher3;\n\n      (_dispatcher3 = this._dispatcher).off.apply(_dispatcher3, arguments);\n      return this;\n    }\n  }, {\n    key: 'emit',\n    value: function emit() {\n      var _dispatcher4;\n\n      (_dispatcher4 = this._dispatcher).emit.apply(_dispatcher4, arguments);\n      return this;\n    }\n  }, {\n    key: 'destroy',\n    value: function destroy() {\n      this._dispatcher.destroy();\n    }\n  }]);\n\n  return _class;\n}();\n\nexports.default = _class;\n\n//# sourceURL=webpack:///./core/module.js?");
